...
public class SnmpManager {
     ...
     *
     * @throws net.percederberg.mibble.browser.SnmpException if an SNMP context pool couldn't be
     ...
     *
     * @throws net.percederberg.mibble.browser.SnmpException if the SNMP request failed
     */
     ...
     *
     * @throws net.percederberg.mibble.browser.SnmpException if the OID couldn't be added correctly
     */
     ...
     *
     * @throws net.percederberg.mibble.browser.SnmpException if the type is unsupported or if the
     ...
     *
     * @throws net.percederberg.mibble.browser.SnmpException if the value couldn't be parsed
     *             correctly
     */
