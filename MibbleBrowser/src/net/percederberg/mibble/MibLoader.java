...
public class MibLoader {
     ...
     *
     * @throws java.io.IOException if the MIB file couldn't be found in the
     *             MIB search path
     * @throws net.percederberg.mibble.MibLoaderException if the MIB file couldn't be loaded
     *             correctly
     */
     ...
     * @return the MIB file loaded
     *
     * @throws java.io.IOException if the MIB file couldn't be read
     * @throws net.percederberg.mibble.MibLoaderException if the MIB file couldn't be loaded
     *             correctly
     */
     ...
     * @return the MIB file loaded
     *
     * @throws java.io.IOException if the MIB URL couldn't be read
     * @throws net.percederberg.mibble.MibLoaderException if the MIB file couldn't be loaded
     *             correctly
     *
     * @since 2.3
     ...
     * @return the MIB file loaded
     *
     * @throws java.io.IOException if the input stream couldn't be read
     * @throws net.percederberg.mibble.MibLoaderException if the MIB file couldn't be loaded
     *             correctly
     *
     * @since 2.3
     ...
     *
     * @throws java.io.IOException if the MIB couldn't be found
     * @throws net.percederberg.mibble.MibLoaderException if the MIB couldn't be loaded
     *             correctly
     */
     ...
     *
     * @throws net.percederberg.mibble.MibLoaderException if the MIB couldn't be unloaded
     ...
     *
     * @throws java.io.IOException if the MIB file in the queue couldn't be
     *             found
     */
    ...
    private class MibSource {
         ...
         *
         * @throws java.io.IOException if the MIB couldn't be found
         * @throws net.percederberg.mibble.MibLoaderException if the MIB couldn't be parsed
